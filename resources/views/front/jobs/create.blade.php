  ...
  <div class="wrap">
    ...
    <form method="POST" action="{{ route('front.jobs.store') }}" enctype="multipart/form-data">
      ...
      <div class="card">
        ...
        <div class="grid">
          <div class="field">
            <label for="title">タイトル <span class="help">必須</span></label>
        ...
        <div class="field">
          ...
          <textarea id="summary" name="summary" placeholder="イントロダクションや要点">{{ old('summary') }}</textarea>
        </div>

        <div class="field">
          <label for="body">本文（仕事内容・必須スキル・歓迎・福利厚生など） <span class="help">必須</span></label>
        ...
        <div class="field">
          ...
          @error('image')
            <div class="help" style="color:#b30000">{{ $message }}</div>
          @enderror
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="grid">
          ...
          <div class="field">
            <label for="work_style">働き方</label>
        ...
        <div class="grid">
          <div class="field">
            <label for="salary_unit">単位</label>
            <select id="salary_unit" name="salary_unit">
          ...
          <div class="field">
            <label for="tags">タグ（スペース区切り）</label>
            <input id="tags" name="tags" type="text" placeholder="例）Laravel Vue AWS" value="{{ old('tags') }}">
          </div>
        </div>
      </div>
